...
namespace DataService.Web.Components
{
    /// <summary>
    /// Handler providing functionality for blocking user access 
    /// to a web site based on IP-address.
    /// </summary>
    public class WhiteListIpHandler
    {   
        /// <summary>
        /// 定义白名单
        /// </summary>
        private const string FILE_PATH_WhiteList = @"~\Config\whitelist.txt";
        ...
        private FileContents ReadBannedIpListFile()
        {
            ...
            if (fileContents == null)
            {
                ...
                string cachedFilePath = HostingEnvironment.MapPath(FILE_PATH_WhiteList);
